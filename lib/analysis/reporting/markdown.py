from reporting.reporter import DocumentReporter

class MarkdownReporter(DocumentReporter):

    def RenderHeader(self, reportNum, **fields):
        header = f"# Report #{reportNum}\n\n"
